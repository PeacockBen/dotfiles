...
## The stack
My rice uses i3 as a window manager, eww for a sidebar, and picom for compositing shadows, blur, transparency, transitions etc.
...
- the volume slider react to hardware volume buttons
